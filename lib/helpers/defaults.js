...
async function loadClientGrantScopes(ctx, client, audience) {
  return [];
}
  ...
  const defaults = {
    ...
    features: {
      ...
      registration: {
         ...
         *
         * ```js
         * new (provider.InitialAccessToken)({}).save(ctx).then(console.log);
         * ```
         */
         ...
         * created like so
         * ```js
         * new (provider.InitialAccessToken)({ policies: ['my-policy', 'my-policy-2'] }).save(ctx).then(console.log);
         * ```
         *
