    ...
    middleware: [
      ...
      async function findClientId(ctx, next) {
        ...
        if (ctx.headers.authorization !== undefined) {
          ...
          console.log('ctx.headers.authorization', clientSecret);
        ...
        if (clientAssertion !== undefined) {
          console.log('clientAssertion !== undefined');
      ...
      async function loadClient(ctx, next) {
        const client = await provider.Client.find(ctx, ctx.oidc.authorization.clientId);
      ...
      async function auth(ctx, next) {
        ...
        console.log('methods: ', methods, clientMethod);
